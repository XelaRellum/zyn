...
unsigned int
zyn_component_filter_envelope_get_shape(
  void * context)
{
  assert(0);
  return 0;
...
void
zyn_component_filter_envelope_set_shape(
  void * context,
  unsigned int value)
{
}
...
unsigned int
zyn_component_filter_envelope_get_filter_type(
  void * context)
{
  assert(0);
  return 0;
...
void
zyn_component_filter_envelope_set_filter_type(
  void * context,
  unsigned int value)
{
  assert(0);
...
unsigned int
zyn_component_filter_envelope_get_analog_filter_type(
  void * context)
{
  assert(0);
  return 0;
...
void
zyn_component_filter_envelope_set_analog_filter_type(
  void * context,
  unsigned int value)
{
  assert(0);
