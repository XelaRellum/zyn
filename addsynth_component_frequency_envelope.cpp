...
float
zyn_component_frequency_envelope_get_float(
  void * context,
...
void
zyn_component_frequency_envelope_set_float(
  void * context,
  unsigned int parameter,
  float value)
{
...
signed int
zyn_component_frequency_envelope_get_int(
  void * context,
  unsigned int parameter)
{
  assert(0);
...
void
zyn_component_frequency_envelope_set_int(
  void * context,
  unsigned int parameter,
  signed int value)
{
...
bool
zyn_component_frequency_envelope_get_bool(
  void * context,
  unsigned int parameter)
{
  switch (parameter)
...
void
zyn_component_frequency_envelope_set_bool(
  void * context,
  unsigned int parameter,
  bool value)
{
...
{
  ZYN_INIT_COMPONENT(component_ptr, envelope_params_ptr, zyn_component_frequency_envelope_);
}
