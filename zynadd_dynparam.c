...
void zynadd_map_initialise()
{
  ...
  LV2DYNPARAM_GROUP_INIT_GENERIC(ROOT, AMPLITUDE, "Amplitude");
  {
    ...
    {
      LV2DYNPARAM_PARAMETER_INIT_FLOAT(AMPLITUDE_ENVELOPE, AMP_ENV_ATTACK, "Attack", 0, 100, FALSE);
      LV2DYNPARAM_PARAMETER_INIT_FLOAT(AMPLITUDE_ENVELOPE, AMP_ENV_DECAY, "Decay", 0, 100, FALSE);
      LV2DYNPARAM_PARAMETER_INIT_FLOAT(AMPLITUDE_ENVELOPE, AMP_ENV_SUSTAIN, "Sustain", 0, 100, FALSE);
      LV2DYNPARAM_PARAMETER_INIT_FLOAT(AMPLITUDE_ENVELOPE, AMP_ENV_RELEASE, "Release", 0, 100, FALSE);
      LV2DYNPARAM_PARAMETER_INIT_FLOAT(AMPLITUDE_ENVELOPE, AMP_ENV_STRETCH, "Stretch", 0, 200, FALSE);
      LV2DYNPARAM_PARAMETER_INIT_BOOL(AMPLITUDE_ENVELOPE, AMP_ENV_FORCED_RELEASE, "Forced release", FALSE);
      LV2DYNPARAM_PARAMETER_INIT_BOOL(AMPLITUDE_ENVELOPE, AMP_ENV_LINEAR, "Linear", FALSE);
    }
